...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp... Please Wait.')}`);
    ...
    WhatsAsenaCN.on('open', async () => {
        ...
        let EVA_ACTİON = config.LANG == 'TR' || config.LANG == 'AZ' ? '*RIKI Working as a Chatbot! 🐺*\n\n_The purpose of this mod is to turn the bot into a fully functional AI chatbot._\n_You can use the_ *.fulleva off* _command to return to normal mode._\n\n*Thanks For Using RUKI BOT 💌*\n    *- Eva*'
                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                if (error.message.includes('URL')) {
                                    return await WhatsAsenaCN.sendMessage(WhatsAsenaCN.user.jid, '*⚕️ HATA ÇÖZÜMLEME [RIKI] ⚕️*' + 
                                        '\n========== ```Hata Okundu!``` ==========' +
                                ...
                                if (error.message.includes('URL')) {
                                    return await WhatsAsenaCN.sendMessage(WhatsAsenaCN.user.jid, '*⚕️ ERROR ANALYSIS [RIKI] ⚕️*' + 
                                        '\n========== ```Error Resolved!``` ==========' +
